...
import java.util.Random; // java.util.*; << 표시하면 모든 기능을 사용한다는 의미 
...
public class Ex01_random {
	public static void main(String[] args) {
		...
		System.out.println(ran.nextInt(10)); 		// 10개 중에서 1개 난수 발생(0~9)
